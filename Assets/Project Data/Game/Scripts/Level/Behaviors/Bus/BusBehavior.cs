...
namespace Watermelon
{
    public class BusBehavior : MonoBehaviour
    {
        ...
        public void MoveToExit()
        {
            ...
            // Notify order system that this bus is completed
            NotifyBusCompleted();
        ...
        /// <summary>
        /// Notify the order tracking system that this bus has been completed
        /// </summary>
        private void NotifyBusCompleted()
        {
            ...
            {
                LevelController.OrderTracker.MarkBusCompleted(Type);
            }
        }
