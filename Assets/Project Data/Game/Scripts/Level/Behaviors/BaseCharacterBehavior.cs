...
namespace Watermelon.BusStop
{
    public abstract class BaseCharacterBehavior : LevelElementBehavior, IClickableObject
    {
        ...
        private void Awake()
        {
            ...
            // Hide the custom material object by default
            if (customMaterialObject != null)
            {
                customMaterialObject.SetActive(false);
            }
        }
        ...
        public void SetCustomMaterial(Material customMaterial)
        {
            ...
            // Show the custom material object
            if (customMaterialObject != null)
            {
                customMaterialObject.SetActive(true);
            }
        }
        ...
        public void ResetMaterial()
        {
            ...
            // Hide the custom material object
            if (customMaterialObject != null)
            {
                customMaterialObject.SetActive(false);
            }
