    ...
    public static class ConveyorChefGameplayHUDStyler
    {
        ...
        private static void StyleOrderPanel(Transform root)
        {
            ...
            if (bg != null)
            {
                ...
                if (bg.GetComponent<Shadow>() == null)
                {
                    Shadow shadow = bg.gameObject.AddComponent<Shadow>();
                    shadow.effectColor = new Color(0.15f, 0.08f, 0.03f, 0.30f);
        ...
        private static void EnsurePill(RectTransform textRect, Color color, string name)
        {
            ...
            shadow.effectColor = new Color(0.10f, 0.05f, 0.02f, 0.30f);
