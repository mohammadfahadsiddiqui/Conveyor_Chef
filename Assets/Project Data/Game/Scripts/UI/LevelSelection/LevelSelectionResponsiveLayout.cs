...
namespace Watermelon
{
    ...
    /// never changes RectTransforms so Scene view == Play Mode. Layout v6 is
    /// measured from the approved Level Selection reference.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class LevelSelectionResponsiveLayout : MonoBehaviour
    {
        [SerializeField] private Vector2 referenceResolution = new Vector2(1080f, 1920f);
        [SerializeField] private int layoutVersion = 6;
